...
A few \doxylink{class_eigen_1_1_matrix_base}{Matrix\+Base} methods are considered experimental, hence not part of any API stability guarantee\+: \begin{DoxyItemize}
